...
import { articleApi, commentApi, getFileUrl } from '../api';
  ...
  return (
    ...
    >
      ...
      <section className="relative h-[90vh] min-h-[700px] flex flex-col items-center justify-center overflow-hidden bg-zinc-950">
        ...
        >
          <img 
            src={getFileUrl(article.coverImage) || "https://images.unsplash.com/photo-1633167606207-d840b5070fc2?q=80&w=1000&auto=format&fit=crop"} 
            alt={article.title} 
