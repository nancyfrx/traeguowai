...
async function testImageGeneration() {
    ...
    const models = ['cogview-4', 'cogview-3-plus'];
    ...
    for (const model of models) {
        ...
        try {
            ...
            console.log('成功! 响应数据:', data);
            
            if (data.data && data.data[0]) {
                console.log('图片URL:', data.data[0].url);
            }
...
async function testVideoGeneration() {
    ...
    for (const model of models) {
        ...
        try {
            ...
            if (data.data && data.data[0]) {
                console.log('视频URL:', data.data[0].url);
            }
...
async function testChatModels() {
    ...
    const models = ['glm-4', 'glm-4-flash', 'glm-4-plus', 'glm-4-air'];
    ...
    for (const model of models) {
        ...
        try {
            ...
            const data = await response.json();
            console.log('成功! 响应:', data.choices[0].message.content);
